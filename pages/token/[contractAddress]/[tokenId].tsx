...
export default function TokenPage({ nft, contractMetadata }: Props) {
    const client = createThirdwebClient({
        clientId: "2225c0191997baa814acd65aa79485ee",
        // secretKey: "nd-1_09q0rBGuo-gpyT9sQ9erdp0v22zPs_1aNvti9-HptZ1BpHFN6vlikCV_IHK177uNpm698inr4eTJCjuJw", // Use secret key if using on the server, get it from dashboard settings
      });
